...
class PositionalEmbeddingLearned(nn.Module):
    ...
    def __init__(self, num_queries=10, d_model=512):
        super().__init__()
        self.time_embed = nn.Embedding(num_queries, d_model)
        self.reset_parameters()
    ...
    def forward(self, ln):
        return self.time_embed.weight[:ln].unsqueeze(0) # 1xlnxd_model (1xobjectsxdmodel)
